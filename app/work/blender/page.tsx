      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6">
            Blender <span className="text-red-600">Mastery</span>.
          </h1>
          <p className="text-zinc-400 text-lg max-w-2xl leading-relaxed">
            A collection of high-fidelity 3D models and architectural visualizations 
            created using Blender. Focused on lighting, texturing, and realistic geometry.
          </p>
        </motion.div>
        ...
        <section className="mb-20">
          <div className="relative w-full aspect-video rounded-3xl overflow-hidden border border-zinc-900">
            <Image 
              src="/blender1.png" // CHANGE THIS per page (e.g., /blender-hero.jpg)
              alt="Main Render"
              fill
